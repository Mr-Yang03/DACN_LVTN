...
export default function ReportPage() {
  ...
  // const filteredFeedback = feedbackFilter === "all" ? feedbackItems
  //     : feedbackItems.filter((item) => {
  //         if (feedbackFilter === "pending") return item.status === "Chưa xử lý" || item.status === "Đang xử lý"
  //         if (feedbackFilter === "resolved") return item.status === "Đã xử lý"
  ...
  const currentFeedbackItems = feedbackItems.slice(indexOfFirstItem, indexOfLastItem)
  ...
  return (
    <>
      ...
      {/* Pagination */}
      <PaginationDemo totalItems={feedbackItems.length} 
